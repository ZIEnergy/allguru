...
$(".form__category-item").click(function(t){t.preventDefault(),$(".form__category-item").removeClass("form__category-item--active"),$(this).addClass("form__category-item--active")}),$(".form__ad-settings-item").click(function(t){t.preventDefault(),$(".form__ad-settings-item").removeClass("form__ad-settings-item--active"),$(this).addClass("form__ad-settings-item--active")});
...
$(".header__menu-button").click(function(e){e.preventDefault(),$(this).toggleClass("header__menu-button--active"),$(".header__content").fadeToggle("fast").css("display","flex")});
